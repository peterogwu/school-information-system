...
<a href="staffupdate.jsp"class="btn btn-success btn-xs">REFRESH</a></CENTER>  
    
<TR><TD>&nbsp;</td>
<td>&nbsp;</td> 
<center><h2><font color="green">  fill out the following form</h2></center></font>
<FORM action="staffupdate.jsp" method="post" allign="center" >
<table align="center"  >
...
<TD>FIRST NAME:</TD><TD><INPUT type="TEXT" name="firstname"size="30"placeholder="ENTER YOUR FIRSTNAME"></td>  
<TD>LAST NAME:</TD><TD><INPUT type="TEXT" name="lastname"size="30"placeholder="ENTER YOUR LASTNAME"></td> 
...
<tr>
<TD>DATE OF BIRTHDAY:</TD><TD><INPUT type="TEXT" name="db"size="30"placeholder="ENTER YOUR DAATE OF BIRTHDAY"></td> 
...
<TD>CGP:</TD><TD><INPUT type="TEXT" name="cgp"size="30"placeholder="ENTER YOUR CGP"></td> 
...
<td>&nbsp;</td> 
<TR> 
<TD>EXPERIENCE:</TD><TD><INPUT type="number" name="exp"size="30"placeholder="ENTER YOUR EXPERRIENCE" min="0" max="30"></td> 
...
<TD>NATIONALITY:</TD><TD><INPUT type="TEXT" name="country"size="30"placeholder="ENTER YOUR NATIONLITY"></td> 
...
<tr><th><font color="red" ><CENTER>successfully updated.</th></tr></font></CENTER> 
</table>
