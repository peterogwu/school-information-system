...
<FORM action="update.jsp" method="post" allign="center"id="form1" name="form1" onsubmit="return validate()" >
<body bgcolor="WHITE">
...
<a href="update.jsp"class="btn btn-success btn-xs">REFRESH</a> 
...
<tr>
<TD>FIRST NAME:</TD><TD><INPUT type="TEXT" name="city"size="30"placeholder="ENTER YOUR FIRSTNAME"></td>  
<TD>LAST NAME:</TD><TD><INPUT type="TEXT" name="name"size="30"placeholder="ENTER YOUR LASTNAME"></td>     
...
<tr>
<TD>PHONE:</TD><TD><INPUT type="TEXT" name="phone2"size="30"placeholder="ENTER YOUR PHONE NUMBER"></td>    
<TD>EMAIL:</TD><TD><INPUT type="email" name="email"size="30"placeholder="ENTER YOUR EMAIL"></td>   
<TD>HOME ADDRESS:</TD><TD><TEXTAREA rows="1" cols="29" name="address"placeholder="ENTER YOUR HOME ADDRESS"></TEXTAREA></TD> 
...
<td>&nbsp;</td>
<TR>
<TD>COUNTRY:</TD><TD><INPUT type="TEXT" name="country"size="30"placeholder="ENTER YOUR COUNTRY"></td>
<TD>DATE:</TD><TD><INPUT type="date" name="date"size="25"placeholder="ENTER YOUR DATE"></td>
</TR>
</table> 
...
<CENTER>
<input type="submit" name=insert.jsp" class="btn btn-primary" value="SUBMIT" >
...
String queryString =  ("update  school set FIRSTNAME=?,LASTNAME=?,MIDDLENAME=?, GENDER=?,DATE_OF_BIRTHDAY=?,PHONE=?,EMAIL=?,ADDRESS=?,DEPARTMENT=?,FALCULTY=?,STATE=?,COUNTRY=?,DATE=? WHERE STUDENTID =?"  );	   
...
pstatement.setString(14,studentid);
