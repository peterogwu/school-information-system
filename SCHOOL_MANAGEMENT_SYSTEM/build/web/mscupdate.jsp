...
<div class="head">
<center> <h1><I><font color="red" background="pink"> MASTER DEGREE ADMINSTRATION PORTAL UPDATE</h1></center></i></font>
</DIV>
<CENTER><a href="index.jsp" class="btn btn-success btn-xs">HOME</a>
<a href="mscupdate.jsp"class="btn btn-success btn-xs">REFRESH</a>   
...
<!--<center><h2><font color="green">  fill out the following form</h2></center></font>-->
<FORM action="mscupdate.jsp" method="post" allign="center"id="form1" >
<table align="center"  >
 
<tr>
<TD>MS ID:</TD><TD><INPUT type="TEXT" name="ph"size="30"placeholder="ENTER YOUR MS ID"required></td> 
...
<TD>L.G.A:</TD><TD><INPUT type="TEXT" name="lga"size="30"placeholder="ENTER YOUR PHONE L.G.A"></td>
</TR>
...
<TD>DATE OF BIRTHDAY:</TD><TD><INPUT type="date" name="db"size="30"placeholder="ENTER YOUR DATE OF BIRTHDAY"></  
...
String queryString = ("update  MASTER set FIRSTNAME=?,DEPARTMENT=?,FALCULTY=?,PHONE=?,EMAIL=?,GRADE=?,ADDRESS=?,LGA=?,TITTLE=?,STATE=?,COUNTRY=?,DATE=?,DATE_OF_BIRTHDAY=? WHERE ID =?"  );	   
...
<tr><th><font color="red" ><CENTER>Data is  successfully updated..</th></tr></font></CENTER> 
</table>
