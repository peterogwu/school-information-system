...
<div class="head">
<center> <h1><I><font color="red" background="pink"> PH.D REGISTRATION FORM</h1></center></i></font>
</DIV>
<CENTER><a href="index.jsp" class="btn btn-success btn-xs">HOME</a>
<a href="delete.jsp"class="btn btn-success btn-xs">REFRESH</a></CENTER>
<TR><TD>&nbsp;</td>
<td>&nbsp;</td>
<center><h2><font color="green">  fill out the following form</h2></center></font>
<!--<center><h2><font color="green">  fill out the following form</h2></center></font>-->
<FORM action="phdform.jsp" method="post" allign="center"id="form1" >
<table align="center"  >
 
<tr>
<TD>PH.D ID:</TD><TD><INPUT type="TEXT" name="ph"size="30"placeholder="ENTER YOUR PH.D ID"required></td> 
<TD>FULL NAME:</TD><TD><INPUT type="TEXT" name="first"size="30"placeholder="ENTER YOUR NAMES"required></td>   
...
<input type="submit" name=search.jsp" class="btn btn-primary" value="SEARCH">
<input type="submit" name=delete.jsp" class="btn btn-danger" value="DELETE">-->
</center>
...
String queryString = ("UPDATE  DOCTOR SET  FIRSTNAME=?,PHONE=?,EMAIL=?,GRADE=?,ADDRESS=?,LGA=?,TITTLE=?,STATE=?,COUNTRY=?,DATE=?,DATE_OF_BIRTHDAY=? WHERE ID=? "); 	   
