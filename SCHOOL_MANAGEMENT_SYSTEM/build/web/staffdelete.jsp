...
<a href="staffdelete.jsp"class="btn btn-success btn-xs">REFRESH</a>
<a href="staffpanel.jsp"class="btn btn-success btn-xs">BACK</a> </CENTER>
<TR><TD>&nbsp;</td>
<td>&nbsp;</td> 
<FORM action="staffdelete.jsp" method="post" allign="center"color="pink" >
<table align="center" >
<TRY>
<TD>STAFF ID:</TD><TD><INPUT type="TEXT" name="studentid"placeholder="ENTER YOUR STAFF ID"required></td> 
</try>
</table> 
...
String queryString = ("delete from STAFF  WHERE STAFFID =?" );	   
