...
<a href="phd.jsp"class="btn btn-success btn-xs">REFRESH</a>   
...
<!--<center><h2><font color="green">  fill out the following form</h2></center></font>-->
<FORM action="phd.jsp" method="post" allign="center"id="form1" >
<table align="center"  >
...
<TD>DATE OF BIRTHDAY:</TD><TD><INPUT type="date" name="db"size="30"placeholder="ENTER YOUR DATE OF BIRTHDAY"required></  
...
String queryString = "INSERT INTO DOCTOR ( ID,FIRSTNAME,DEPARTMENT,FALCULTY,PHONE,EMAIL,GRADE,ADDRESS,LGA,TITTLE,STATE,COUNTRY,DATE,DATE_OF_BIRTHDAY ) VALUES (?, ?, ?, ?, ?,?,?,?,?,?, ?, ?, ?, ?)";	   
