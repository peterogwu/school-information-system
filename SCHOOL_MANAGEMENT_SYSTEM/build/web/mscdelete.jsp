...
<center> <h2><font color="green"> DELETE FORM</h2></center></font>
 ...
 <a href="mscdelete.jsp"class="btn btn-success btn-xs">REFRESH</a>    
  <a href="mscpanel.jsp"class="btn btn-success btn-xs">BACK</a> </CENTER> 
<TR><TD>&nbsp;</td>
<td>&nbsp;</td>
<FORM action="mscdelete.jsp" method="get" allign="center"color="pink" >
<table align="center" >
<TRY>
<TD>MS ID:</TD><TD><INPUT type="TEXT" name="studentid"required></td> 
</try>
</table> 
...
String queryString = ("delete from  MASTER  WHERE ID =?"  );	   
...
<BR>
<TABLE style="background-color: #ffffff;"align="center" WIDTH="30%" border="3"style="border-collapse:collapse"bordercolor="#33FF00">
